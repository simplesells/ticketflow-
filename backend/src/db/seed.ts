...
export function seed() {
  ...
  const items: any[] = [
    { title: '打印机无法打印', description: '三楼财务部打印机输出空白页', type: '报修', priority: '高', status: '处理中', assignee: '张工' },
    ...
    { title: '咨询企业邮箱容量', description: '想了解邮箱存储上限', type: '咨询', priority: '低', status: '已解决', assignee: '李工' },
    { title: '投诉空调温度过低', description: '研发部办公室温度长期过低', type: '投诉', priority: '中', status: '已关闭', assignee: '王工' },
    { title: '网络访问缓慢', description: '下午3-4点内网速度明显下降', type: '报修', priority: '高', status: '处理中', assignee: '张工' },
